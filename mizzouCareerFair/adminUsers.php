        ...
        <div data-role="main" class="ui-content ui-grid-a">
                ...
                <form method="post" id="addAdminForm" action="adminUsers.php#addAdmin" data-ajax="false" >
                        ...
                        <center>-->
                                ...
                                <!--<a href="admin.php#addAdmin" data-inline="true" data-role="button" onclick="submitAdmin();" value="Submit" >Submit</a>-->
                               <!-- <input type="submit" data-inline="true" value="Add Admin" onclick="submitAdmin();" name="Submit">-->
                                <?php if (isset($_POST['Submit'])){ handleNewAdmin();} ?>
                                <!--<input type="submit" data-inline="true" onclick="submitAdmin()" value="Add Admin" name="Add Admin">-->
