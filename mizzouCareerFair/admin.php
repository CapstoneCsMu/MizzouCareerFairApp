<?php
	/*
	File: admin.php
    Parent: tigerspop.php at line 165; index.php at line 102
    Purpose: The purpose of this file is to add additional RSS feeds into the database. It will be implemented into admin.php
	*/
	session_start();
 ?>
<!DOCTYPE html>
